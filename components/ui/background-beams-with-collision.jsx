...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "h-96 md:h-[90vh] relative flex items-center w-full justify-center overflow-hidden",
...
const CollisionMechanism = React.forwardRef(({ parentRef, containerRef, beamOptions = {} }, ref) => {
  ...
  return (<>
    <motion.div
      ...
      className={cn(
        "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-aqua via-purple-500 to-transparent",
